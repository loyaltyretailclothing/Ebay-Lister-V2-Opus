...
// ---------------------------------------------------------------------------
// Description + condition_description templates
// ---------------------------------------------------------------------------
//
// Both the Generate page (after user clicks Analyze) and the Camera flow
// (via /api/drafts/process) must produce the SAME description + condition
// description so drafts look identical regardless of entry point. All rules
