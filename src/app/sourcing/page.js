              ...
              {[
                ...
                <div key={tier.key}>
                  ...
                  <input
                    ...
                    placeholder="0"
                    className="mt-1 w-full rounded-lg border border-zinc-300 bg-white px-2 py-2 text-center text-sm text-zinc-900 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-100"
                  />
                </div>
              ))}
            </div>
