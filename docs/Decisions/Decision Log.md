...
| 2026-09-18 | Camera white balance: only Auto and Daylight; the camera starts on Daylight | Daylight is the only preset used. Chrome on Android snaps white balance to Android's fixed presets (Daylight = 5000K), so this matches the phone exactly. |
| 2026-09-18 | Camera focus box: appears under the tap, fades after ~1.5s, no box parked in the centre; focus point mapped to the full camera frame | The box was drawn off the tap and snapped back; the focus point landed beside the tap. |
